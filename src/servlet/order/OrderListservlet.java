...
public class OrderListservlet  extends HttpServlet{
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
	    ...
	    PrintWriter out = resp.getWriter();
		 ...
		 List<Orders> ordersList = (List)req.getAttribute("orderList");
		 out.println("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\">");
			...
			out.println("				<td class=tablebody1 valign=middle>&nbsp;&nbsp;<a href=\"order1.do?id="+order.getOrderid()+"\">"+order.getOrderid()+"</a></td>");
			...
			out.println("					<input type=\"button\" value=\"删除\" onclick=\"javascript:window.location='order2.do?id="+order.getOrderid()+"';\">&nbsp;");
			out.println("					<input type=\"button\" value=\"明细\" onclick=\"javascript:window.location='order1.do?id="+order.getOrderid()+"';\">");
			out.println("				</td>");
			out.println("			</tr>");
			 }
