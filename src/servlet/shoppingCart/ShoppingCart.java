...
public class ShoppingCart extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		    ...
		    out.println("				<form>");
		    out.println("					<input type=\"button\" value=\"提交订单\" size=\"1\" onclick=\"javascript:window.location='shop1.do';\">");
		    out.println("					<input type=\"button\" value=\"继续购物\" size=\"2\" onclick=\"javascript:window.location='product2.do';\">");
		    out.println("					<input type=\"button\" value=\"清空购物车\" size=\"2\" onclick=\"javascript:window.location='product2.do';\">");
		    out.println("				</form>");
		    out.println("				</td>");
		    out.println("			</tr>");
		    out.println("		</table>");
